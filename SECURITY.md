...
`soroban-errcode-lint` is a read-only static analysis tool. It parses Rust
...
[security advisory form](https://github.com/eleven-smg/soroban-errcode-lint/security/advisories/new)
...
Vulnerabilities in the Soroban contracts you point the linter at. Report those
