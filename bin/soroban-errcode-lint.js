...
const USAGE = `soroban-errcode-lint [options] [paths...]

Lints Soroban contract error codes. Scans Rust sources for #[contracterror]
enums and reports duplicate discriminants, cross-contract code collisions and
...
try {
	...
	process.stderr.write(`soroban-errcode-lint: ${error.message}\n`)
	process.exit(2)
}
